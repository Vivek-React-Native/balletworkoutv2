...
const VIEW_CALLBACK_ENUMS = {
    REGISTER_WITH_APPLE: 'registration/register-with-apple',
}
...
export default class AppleSignUpButton extends Component<Props, State> {
        ...
        try {
            ...
            if (credentialState === AppleAuthCredentialState.AUTHORIZED) {
                ...
                let registrationData = {
                    ...
                    fb_id: appleAuthRequestResponse.user,
                ...
                this.viewCallbackHandler(VIEW_CALLBACK_ENUMS.REGISTER_WITH_APPLE, registrationData);
...
export { VIEW_CALLBACK_ENUMS as APPLE_SIGNUP_CALLBACK_ENUMS };
